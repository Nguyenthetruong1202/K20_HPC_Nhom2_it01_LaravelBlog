      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                  <li class="nav-item active">
                        <a class="nav-link" href="<?php echo e(route('blog')); ?>">Trang chủ <span
                                    class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('blog-post')); ?>">Giới thiệu về trường học</a>
                  </li>
                  <li class="nav-item">
...
</nav><?php /**PATH E:\lam_viec_nhom\bai_tap_nhom_2\resources\views\blog\heade.blade.php ENDPATH**/ ?>